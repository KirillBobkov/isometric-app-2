...
import { Grid, Collapse, Container, Button } from "@mui/material";
      ...
      <Grid container spacing={4} mb={8}>
        ...
        <Grid item xs={12} md={6}>
          <InfoCard
            ...
            content="• Использует режим Load Mode вместо Timed Mode
...
6. Отдыхайте 1 минуту между повторениями"
        ...
        <Grid item xs={12} md={6}>
          <InfoCard
            ...
            content="• Записывайте в журнал Целевую Нагрузку и длительность каждого удержания
