        ...
        <Grid container spacing={4} mb={8}>
          ...
          <Grid item xs={12} md={6}>
            <InfoCard
              ...
              content="• День 1: Верхняя часть тела
...
7. Записывайте время удержания и среднюю нагрузку"
          ...
          <Grid item xs={12} md={6}>
            <InfoCard
              title="Важные нюансы"
              content="• Не требуется намеренно увеличивать нагрузку или время — прогресс происходит автоматически
