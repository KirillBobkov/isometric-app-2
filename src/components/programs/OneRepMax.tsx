        ...
        <Grid container spacing={4} mb={8}>
          ...
          <Grid item xs={12} md={6}>
            <InfoCard
              ...
              content="• Для определения процентных показателей в программах типа '6 x 6'
...
4. Отдых 30 секунд между разминочными подходами"
          ...
          <Grid item xs={12} md={6}>
            <InfoCard
              ...
              content="• Выполните три максимальных попытки
