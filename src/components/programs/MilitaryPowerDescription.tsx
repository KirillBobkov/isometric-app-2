...
import { Grid, Typography, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Paper, Box } from '@mui/material';
import { InfoCard } from '../InfoCard';

export const MilitaryPowerDescription: FC = () => {
  return (
