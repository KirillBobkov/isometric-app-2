      ...
      <Grid container spacing={4} mb={8}>
        ...
        <Grid item xs={12} md={6}>
          <InfoCard
            ...
            content="• Классическая схема: 4 подхода по 10 повторений
...
7. Отдыхайте 30 секунд между подходами"
        ...
        <Grid item xs={12} md={6}>
          <InfoCard
            ...
            content="• Записывайте в журнал Целевую Нагрузку, количество подходов и повторений
