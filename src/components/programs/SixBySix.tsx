        ...
        <Grid container spacing={4} mb={8}>
          ...
          <Grid item xs={12} md={6}>
            <InfoCard>
              ...
              <Typography variant="body2" color="text.secondary">
                '6 x 6' — это программа, похожая на The Promethean, но с особым акцентом на идеальное сочетание длительности (6 секунд) и количества повторений (6). Программа использует немного сниженную интенсивность для поддержания этих идеальных показателей. Отлично подходит для общего развития силы на любом уровне подготовки.
              </Typography>
            </InfoCard>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <InfoCard>
              ...
              <Typography variant="body2" color="text.secondary">
                • Фиксированное количество повторений: 6
          ...
          <Grid item xs={12} md={6}>
            <InfoCard>
              ...
              <Typography variant="body2" color="text.secondary">
                • Записывайте в журнал Целевую Нагрузку, количество повторений и их длительность
